...
CELERYBEAT_SCHEDULE = {
    'get-byfly-connections-data-every-1-minutes': {
        'task': 'tasks.load_byfly_data',
        'schedule': timedelta(seconds=5*60),
    },
    'get-mts-connections-data-every-1-minutes': {
        'task': 'tasks.load_mts_data',
        'schedule': timedelta(seconds=4*60),
    },
    'get-flynet-connections-data-every-1-minutes': {
        'task': 'tasks.load_flynet_data',
        'schedule': timedelta(seconds=4*60),
    },
    'get-unet-connections-data-every-1-minutes': {
        'task': 'tasks.load_unet_data',
        'schedule': timedelta(seconds=4*60),
    },
    'get-atlant-connections-data-every-1-minutes': {
